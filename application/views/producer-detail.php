      ...
      <div class="col-md-6">
        <div class="slide-wrapper">
          <div class="slider slider-single">
            ...
            <?php endforeach;?>
            <!--
            <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
          ...
          <div class="slider slider-nav">
             <?php foreach($rs['data'][0]['image_list'] as $img):?>
              <div class="thumbnail-wrapper"><img src="<?php echo $img['full'];?>" alt=""></div>
            <?php endforeach;?>

            <!-- <div class="thumbnail-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="thumbnail-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="thumbnail-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="thumbnail-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div>
            <div class="thumbnail-wrapper"><img src="<?php echo base_url('public');?>/images/producer-slide-1.jpg" alt=""></div> -->
        ...
        <div class="text-detail">
          ...
          <div class="row other-product">
            <div class="col-xs-6 col-sm-3"><a class="product-wrapper" href="">
                <div class="img-wrapper"><img src="<?php echo base_url('public');?>/images/other-product.png" alt=""></div>
