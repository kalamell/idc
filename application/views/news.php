      ...
      <section class="section-wrapper">
        <div class="container">
          <h2 class="header-text">news&event</h2>
          <div class="box-sub">
            <h2>NEWS</h2>
          </div>
          <div class="row equal">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="block-wrapper"><a href="<?php echo site_url('news/'.$v['category']['_id'].'/'.$v['_id']);?>">
                  <div class="responsive-img-sm"><img src="<?php echo $v['image']['thumbnail'];?>" alt=""></div></a><a class="title" href="<?php echo site_url('news/'.$v['category']['_id'].'/'.$v['_id']);?>"><?php echo $v['title'];?></a>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="block-wrapper half">
                <div class="row">
                  <div class="col-xs-6"><a href="<?php echo site_url('news/'.$v['category']['_id'].'/'.$v['_id']);?>">
                      <div class="responsive-img-sm noreadmore"><img src="<?php echo $v['image']['thumbnail'];?>" alt=""></div></a></div>
                  <div class="col-xs-6">
