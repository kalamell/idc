...
class KnowledgeApi
{
     ...
     */
    public function getKnowledge($platform, $x_access_token, $x_user, $knowledge_category_id, $lang = 'th')
    {
        list($response) = $this->getKnowledgeWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $lang);
        return $response;
    }
     ...
     */
    public function getKnowledgeWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $lang = 'th')
    {
        $returnType = '\Swagger\Client\Model\KnowledgeResponse';
        $request = $this->getKnowledgeRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $lang);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKnowledgeAsync($platform, $x_access_token, $x_user, $knowledge_category_id, $lang = 'th')
    {
        return $this->getKnowledgeAsyncWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $lang)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKnowledgeAsyncWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $lang = 'th')
    {
        $returnType = '\Swagger\Client\Model\KnowledgeResponse';
        $request = $this->getKnowledgeRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $lang);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getKnowledgeRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $lang = 'th')
    {
        // verify the required parameter 'platform' is set
        if ($platform === null) {
            throw new \InvalidArgumentException(
        ...
        if ($x_access_token === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_access_token when calling getKnowledge'
            );
        }
        // verify the required parameter 'x_user' is set
        if ($x_user === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user when calling getKnowledge'
            );
        }
     ...
     * @return \Swagger\Client\Model\KnowledgeResponse
     */
    public function getKnowledgeById($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang = 'th')
    {
        list($response) = $this->getKnowledgeByIdWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\KnowledgeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getKnowledgeByIdWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang = 'th')
    {
        $returnType = '\Swagger\Client\Model\KnowledgeResponse';
        $request = $this->getKnowledgeByIdRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKnowledgeByIdAsync($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang = 'th')
    {
        return $this->getKnowledgeByIdAsyncWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKnowledgeByIdAsyncWithHttpInfo($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang = 'th')
    {
        $returnType = '\Swagger\Client\Model\KnowledgeResponse';
        $request = $this->getKnowledgeByIdRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getKnowledgeByIdRequest($platform, $x_access_token, $x_user, $knowledge_category_id, $knowledge_id, $lang = 'th')
    {
        // verify the required parameter 'platform' is set
        if ($platform === null) {
            throw new \InvalidArgumentException(
        ...
        if ($x_access_token === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_access_token when calling getKnowledgeById'
            );
        }
        // verify the required parameter 'x_user' is set
        if ($x_user === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user when calling getKnowledgeById'
            );
        }
        // verify the required parameter 'knowledge_category_id' is set
        if ($knowledge_category_id === null) {
